    ...
    <div className="techstack" ref={containerRef}>
      ...
      <div className="tech-marquee-wrap">
        <div className="tech-marquee tech-marquee-left">
          {[...Array(4)].map((_, ri) => (
            <div className="tech-marquee-track" key={ri}>
              {[
          ...
          {[...Array(4)].map((_, ri) => (
            <div className="tech-marquee-track" key={ri}>
              {[
                ...
                { src: "images/python2.png", name: "Python" },
                { src: "images/docker.png", name: "Docker" },
                { src: "images/kubernetes.png", name: "Kubernetes" },
                { src: "images/aws.png", name: "AWS" },
                { src: "images/azure.png", name: "Azure" },
                { src: "images/jenkins.png", name: "Jenkins" },
                { src: "images/salesforce.jpeg", name: "Salesforce" },
              ].map((tech, i) => (
                <div className="tech-marquee-item" key={i}>
                  <img src={tech.src} alt={tech.name} />
                  <span>{tech.name}</span>
